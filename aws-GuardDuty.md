...
GuardDuty is a managed, non-invasive service. It pulls data directly from AWS infrastructure logs (VPC Flow Logs, DNS logs, and CloudTrail) rather than using an agent. Because it consumes these logs independently of your compute resources, it has zero impact on CPU/Memory or network latency.
GuardDuty is reactive/behavioral.
...
Its Charged per GB of EBS volume scanned
...
1. A finding is a structured security alert describing:
